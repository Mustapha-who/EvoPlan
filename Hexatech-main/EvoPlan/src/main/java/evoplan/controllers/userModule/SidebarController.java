...
public class SidebarController {
    ...
    @FXML private AnchorPane contentPane; // Content area reference

    public void initialize() {
        loadPage("/AdminDashboard.fxml"); // Load dashboard by default
    }
    ...
    @FXML private void loadDashboard() { loadPage("/AdminDashboard.fxml"); }
    @FXML private void loadManageUsers() { loadPage("/Manage_Users.fxml"); }
    @FXML private void loadManageClaims() { loadPage("/AdminFeedbackManagement.fxml"); }
